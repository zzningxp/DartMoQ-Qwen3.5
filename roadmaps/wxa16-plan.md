...
并没有修复 wxa16_memory_stats.py 的统计问题：

添加了 collect_all_linears 函数，可以递归查找模块中所有的线性层，不管它们叫什么名字
添加了 calculate_attn_total 函数，用通用的方法统计注意力层的大小
添加了调试输出，可以看到实际找到了哪些层

我觉得现在的核心问题是 attention 没有被量化。
